...
class PreferencesDialog(PreferencesBaseDialog):
    ...
    def _create_stage_page(self) -> None:
        ...
        sizer = wx.StaticBoxSizer(
            wx.StaticBox(panel, wx.ID_ANY, "General"), wx.HORIZONTAL
        )
        grid_sizer = wx.GridBagSizer(hgap=3, vgap=3)

        grid_sizer.Add(
            wx.StaticText(panel, wx.ID_ANY, "Position polling rate (sec)"),
            pos=(0, 0),
            span=(1, 1),
        ...
        sizer = wx.StaticBoxSizer(
            wx.StaticBox(panel, wx.ID_ANY, "Position Limits"), wx.HORIZONTAL
        )
        grid_sizer = wx.FlexGridSizer(4, 3, 5, 5)

        grid_sizer.Add((0, 0), 0, 0, 0)
        grid_sizer.Add(
            wx.StaticText(panel, wx.ID_ANY, "Minimum"), 0, wx.ALIGN_CENTER, 0
        )
        grid_sizer.Add(
            wx.StaticText(panel, wx.ID_ANY, "Maximum"), 0, wx.ALIGN_CENTER, 0
        )
        ...
        sizer = wx.StaticBoxSizer(
            wx.StaticBox(panel, wx.ID_ANY, "Referencing"), wx.HORIZONTAL
        )
        grid_sizer = wx.GridBagSizer(hgap=3, vgap=3)

        ctrl = wx.CheckBox(
            panel, wx.ID_ANY, "Find position references when connection is established"
        )
    ...
    def _create_camera_page(self) -> None:
        ...
        grid_sizer.Add(
            wx.StaticText(panel, wx.ID_ANY, "Show feed in separate window"),
            pos=(0, 0),
            span=(1, 1),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
